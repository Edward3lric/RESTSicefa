...
export function addProducto(){
    ...
    fetch("../api/restproducto/insert", options)
...
export function deleteProducto(){
    fetch("../api/restproducto/delete?idP=" + productos[indice].idProducto)
    .then(response => {
        return response.json();
    }).then(
        function(jsondata){
...
export function reactivateProducto(){
    ...
    fetch("../api/restproducto/reactivate?idP=" + productos[indice].idProducto)
    .then(response => {
        return response.json();
    }).then(
        function(jsondata){
...
export function editProducto(){
    ...
    fetch("../api/restproducto/edit", options)
    .then(response => response.json())
    .then(response => {
